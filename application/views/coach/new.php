<div class="container-fluid">
	...
	<form action="<?= base_url('coach/new_action') ?>" method="POST">
		<div class="form-group">
			<input type="text" name="name" class="form-control" placeholder="Coach Full Name" autocomplete="off" autofocus="true">
